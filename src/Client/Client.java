...
public class Client {
	...
	private static PokerWindow window;
	/*
	 From ipconfig:
...
//		}
    ...
    public void setPlayerNumber(int playerNumber) {
        ...
        public IGameState sendCommand (Command cmd)
	{
		IGameState rtnObj = null;
		...
		try {
			...
			do {
                            try
                            {
                                rtnObj = (IGameState)objectIn.readObject();
